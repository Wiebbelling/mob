...
if(isset($_POST['titulo']))
{
	...
	$ret = $acesso->cadastraCategoria($titulo);
}
                  ...
                  <div class="bg-athens-gray bg-wrap">
                    <div class="block-container">
                      <div class="block-left">
                        <p class="rd-navbar-fixed--hidden small">Bem vindo à área Administrativa da MOB Consultoria!</p>
                      </div>
...
<!-- mensagens de alertas -->
      ...
      ?>
    	...
    	<div class="row" style="text-align: center; margin-top: 20px;"><h3>Cadastro de Categorias</h3></div>
        <!-- Login form-->
