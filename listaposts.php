              ...
              <div class="rd-navbar-nav-wrap rd-navbar-nav-dark">
                <div class="rd-navbar-nav-wrap-inner">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="active"><a href="listaposts.php">Posts</a></li>
                    <li><a href="listacategorias.php">Categorias</a></li>
                  ...
                  <table class="table table-athens-gray table-hover">
                    <thead>
                      <tr>
                        ...
                        <th>Categoria</th>
                        <th>Data</th>
                        <th><button class="btn btn-sm btn-curious-blue-outline btn-icon">Novo</button></th>
                        <th></th>
                      </tr>
                    </thead>
                    <tbody>
